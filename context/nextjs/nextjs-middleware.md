...
Learn more in [NextResponse headers in Middleware](@context/nextjs/nextjs-next-response-api.md#next).
...
- [**NextRequest** - API Reference for NextRequest](@context/nextjs/nextjs-next-request-api.md)
- [**NextResponse** - API Reference for NextResponse](@context/nextjs/nextjs-next-response-api.md)